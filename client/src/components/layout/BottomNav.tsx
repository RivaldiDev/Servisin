      ...
      <div className="max-w-md mx-auto px-4 h-16 flex items-center justify-around relative">
        ...
        <div className="relative -top-3 flex flex-col items-center">
          <button
            ...
            className="w-12 h-12 rounded-full bg-gradient-to-tr from-brand-600 to-brand-500 hover:from-brand-700 hover:to-brand-600 text-white shadow-lg shadow-brand-500/30 flex items-center justify-center tap-bounce border-4 border-white transition-all transform active:scale-95"
