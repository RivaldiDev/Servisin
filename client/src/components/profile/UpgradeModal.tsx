...
export const UpgradeModal: React.FC<UpgradeModalProps> = ({ isOpen, onClose, onSuccess }) => {
 ...
 {/* Header */}
 <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between bg-brand-600 ">
 ...
 >
 <div className="absolute -top-2.5 right-3 bg-brand-600 text-white font-extrabold text-[9px] px-2 py-0.5 rounded-full shadow-xs">
 HEMAT 35%
 </div>
 ...
 onClick={handlePay}
 disabled={loading}
 className="w-full py-3.5 bg-brand-600 hover: hover: text-white rounded-2xl font-extrabold text-xs shadow-md shadow-brand-500/25 transition-all flex items-center justify-center gap-2 tap-bounce disabled:opacity-50"
 >
 {loading ? (
