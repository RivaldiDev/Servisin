...
export const GaragePage: React.FC = () => {
 ...
 <div className="bg-brand-600 text-white rounded-3xl p-5 shadow-lg relative overflow-hidden">
 ...
 <div className="p-4 rounded-2xl bg-brand-600 border border-amber-200/80 flex items-center justify-between gap-3">
