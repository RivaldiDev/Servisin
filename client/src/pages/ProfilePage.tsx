...
export const ProfilePage: React.FC = () => {
 ...
 <div className="w-16 h-16 rounded-2xl bg-brand-600 text-white flex items-center justify-center text-xl font-extrabold shadow-md shadow-brand-500/20 uppercase">
 ...
 className="w-full py-3.5 bg-brand-600 hover: hover: text-white rounded-2xl font-extrabold text-xs shadow-md shadow-amber-500/25 transition-all flex items-center justify-center gap-2 tap-bounce"
 >
